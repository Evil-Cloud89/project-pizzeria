...
const app = {
  initPages: function(){
    ...
    thisApp.pages = document.querySelector(select.containerOf.pages).children;        // Wyszukuje wszystkie podstrony 
    thisApp.navLinks = document.querySelectorAll(select.nav.links);                   // Wyszukuje wszystkie linki
  ...
  initCart: function(){ // Inicjowanie koszyka
    const thisApp = this;
