...

{
  ...
  class AmountWidget{
    ...
    setValue(value){ // Pośrednik - ma regulować ilość produktów i nie pozwolić na wpisywanie dowolnej ilości lub dodanie zbyt dużej lub za małej ilości produktu
      const thisWidget = this;
